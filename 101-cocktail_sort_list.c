 ...
 * @list: the pointer to the head of a doubly-linked list
...
/**
 * cocktail_sort_list - func that sorts a doubly linked list of integers
 * in ascending order using the Cocktail shaker sort algorithm
 *
 * @list: the  pointer to the head
 * of a listint_t doubly-linked list
 */
